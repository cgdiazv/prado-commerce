  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-16 text-slate-100">
      <section className="w-full max-w-md rounded-xl border border-white/15 bg-white/8 p-8 backdrop-blur-md">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-white">Set your password</h1>
          ...
          <label className="block">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-white/20 bg-slate-900/70 px-4 py-3 pr-11 text-sm text-slate-100 outline-none transition placeholder:text-slate-400 focus:border-cyan-300/60 focus:ring-2 focus:ring-cyan-300/30"
              />
              <button
                type="button"
